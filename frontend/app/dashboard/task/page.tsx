...
const AssignmentData: AssignmentType[] = [
    {
        ...
        status: "Overdue",
        details: "Frontend Development - CSS Grid & Flexbox",
        dueDate: "Mar 27, 2026",
        color: "text-red-700",
        bgColor: "bg-red-50",
        value: 75,
    ...
    {
        id: 2,
        courseTitle: "JavaScript API Integration",
        status: "Overdue",
        details: "Frontend Development - REST API",
        dueDate: "Mar 25, 2026",
        color: "text-red-700",
        bgColor: "bg-red-50",
        value: 45,
    },
    {
        ...
        status: "Overdue",
        details: "Frontend Development - Redux Toolkit",
        dueDate: "Mar 28, 2026",
        color: "text-red-700",
        bgColor: "bg-red-50",
        value: 30,
    ...
    {
        id: 4,
        courseTitle: "UI/UX Design Portfolio",
        status: "Submitted",
    ...
    {
        id: 5,
        courseTitle: "Database Design Project",
        status: "Submitted",
    ...
    {
        id: 6,
        courseTitle: "Node.js Authentication",
        status: "Pending",
        details: "Backend Development - JWT",
        dueDate: "Apr 5, 2026",
    ...
    },
    {
        ...
        status: "Pending",
        details: "Frontend Development - Tailwind",
        dueDate: "Apr 8, 2026",
        color: "text-yellow-700",
        bgColor: "bg-yellow-50",
        value: 40,
    },
    {
        ...
        status: "Pending",
        details: "Programming - TypeScript",
        dueDate: "Apr 10, 2026",
        color: "text-yellow-700",
        bgColor: "bg-yellow-50",
        value: 25,

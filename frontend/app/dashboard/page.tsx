...
const dataMap: Record<string, ChartDataPoint[]> = {
  ...
  year: [
    ...
    { name: "2024", value: 3200 },
    { name: "2025", value: 3600 },
  ],
};
...
const SidebarItem = ({ icon: Icon, label, active }: SidebarItemProps) => (
  <div
    className={`flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer ${
      active ? "bg-green-700 text-white" : "text-green-500 hover:bg-green-100"
    }`}
  >
    <Icon size={18} />
    ...
    <div className="min-h-screen bg-gradient-to-r from-green-300 to-green-100 p-6">
      <div className="bg-white rounded-3xl flex overflow-hidden shadow-xl relative">
        ...
        <div className="flex-1 p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 max-w-[140px] sm:max-w-none">
                ...
                <div className="text-sm min-w-0">
                  <p className="font-semibold truncate">Charlotte Jane</p>
          ...
          {/* Welcome */}
          <div className="mb-6">
            <h2 className="text-xl font-bold">Welcome back, Jane! 👋</h2>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Module 1: Phishing Attack Simulation
                    </p>
                  </div>
                </div>
                ...
                {["day", "week", "month", "year"].map((p) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm ${
                      period === p ? "bg-green-500 text-white" : "bg-gray-200"
                    }`}
                  >
                    {p}
                  </button>
